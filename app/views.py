...
def index():
    ...
    if request.method == "POST":
        ...
        # Returning template with image, extracted text, and sentiment
        return render_template('index.html', full_filename=full_filename, text=new_string, sentiment=sentiment, score=sentiment_score)
